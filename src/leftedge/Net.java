...
public class Net {
    ...
    public void addTerminal(Terminal trm) {
        ...
        trm.setNet(this);
        if (trm.getColumn() < leftEdge) {
            leftEdge = trm.getColumn();
        }
        if (trm.getColumn() > rightEdge) {
            rightEdge = trm.getColumn();
        }
    }
    ...
    /**
     * Test vertical constraints on this net; @return true if all nets in
     * constraint are already routed
     */
